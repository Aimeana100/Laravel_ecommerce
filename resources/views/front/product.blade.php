                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price">RWf {{$product_attr[$product[0]->id][0]->price}}&nbsp;&nbsp;</span>
                      <span class="aa-product-view-price"><del>Rwf {{$product_attr[$product[0]->id][0]->mrp}}</del></span>
              ...
              @if(isset($related_product[0]))
                    ...
                    <li>
                        ...
                        <figcaption>
                            ...
                            <span class="aa-product-price">RWf {{$related_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>RWf {{$related_product_attr[$productArr->id][0]->mrp}}</del></span>
                        </figcaption>
                        </figure>                          
                    </li>  
                    @endforeach    
