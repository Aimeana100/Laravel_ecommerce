                        ...
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              ...
                              <span class="aa-product-price">Rrw {{$home_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>Rwf {{$home_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                          
                        </li>  
                        @endforeach    
                       ...
                       @foreach($home_featured_product[$list->id] as $productArr)
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              <h4 class="aa-product-title"><a href="{{url('product/'.$productArr->slug)}}">{{$productArr->name}}</a></h4>
                              <span class="aa-product-price">Rwf {{$home_featured_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>Rwf {{$home_featured_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                          
                        </li>  
                        @endforeach    
                       ...
                       @foreach($home_tranding_product[$list->id] as $productArr)
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              <h4 class="aa-product-title"><a href="{{url('product/'.$productArr->slug)}}">{{$productArr->name}}</a></h4>
                              <span class="aa-product-price">Rwf {{$home_tranding_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>Rwf {{$home_tranding_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                          
                        </li>  
                        @endforeach    
                       ...
                       @foreach($home_discounted_product[$list->id] as $productArr)
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              <h4 class="aa-product-title"><a href="{{url('product/'.$productArr->slug)}}">{{$productArr->name}}</a></h4>
                              <span class="aa-product-price">Rwf {{$home_discounted_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>Rrw {{$home_discounted_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                          
                        </li>  
                        @endforeach    
